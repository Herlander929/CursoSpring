...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "herlander97dasilva@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123") );
        Cliente cli2 = new Cliente(null, "Ana Costa", "1bomsaber@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123") );
        cli2.addPerfil(Perfil.ADMIN);
        cli2.getTelefones().addAll(Arrays.asList("93863323", "93338393"));
